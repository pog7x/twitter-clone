<template>
	<aside>
		<div class="sidebar-nav">
			...
			<div class="sidebar-tweet-button" @click="$store.commit('toggleTweetButton')">Tweet</div>
		</div>
		<profile-popup />
		<div class="mobile-close-menu-button" @click="$store.commit('setMobileMenuState', false)">
			<div class="icon">
				<base-icon name="left" />
			</div>
			<span>Close</span>
