		...
		<div class="add-tweet-content">
			...
			<div class="controls">
				<div class="controls-media">
					<div class="controls-media-item" @click="$refs.uploadImageInput.click()">
						<base-icon name="image" />
						<input ref="uploadImageInput" type="file" accept="image/*" hidden @change="showFiles" />
					</div>
					<div class="controls-media-item">
						<base-icon name="gif" />
					</div>
					<div class="controls-media-item">
						<base-icon name="graph" />
					</div>
					<div class="controls-media-item">
						<base-icon name="schedule" />
					</div>
				</div>
				<div class="controls-submit">
					<button :disabled="!hasTweetText()" @click="handleSubmit">Tweet</button>
				</div>
			</div>
		</div>
	</div>
...
<style lang="scss">
@import 'src/assets/theme/colors';
