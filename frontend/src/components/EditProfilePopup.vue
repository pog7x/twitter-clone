	...
	>
		<div class="edit-profile-wrapper">
			<div class="edit-profile-popup-header">
				<div class="close-button" @click="$store.commit('setEditProfileStatus', false)">
				...
				<div class="submit-button">
					<button :disabled="!IsStringsValid || !IsURLValid" @click="submitHandler">Save</button>
				</div>
			</div>
			<div class="edit-form">
...
.edit-profile-popup {
	...
	.edit-profile-wrapper {
		width: 100%;
		max-width: 450px;
		background-color: rgba($color: $color-bg, $alpha: 1);
		border-radius: 1rem;
	}
	&-header {
		width: 100%;
