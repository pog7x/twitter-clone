<template>
	<div class="layout">
		<div class="layout-sidebar">
			<div class="layout-sidebar-fixed-container" :class="{ active: getMobileMenuState }">
				<sidebar />
			</div>
		</div>
...
export default {
	...
	computed: {
		...mapGetters(['getMe', 'getTweetPopupState', 'getProfileTweetCount', 'getLightboxState', 'getMobileMenuState']),
	},
};
</script>
